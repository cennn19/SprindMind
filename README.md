...
```mermaid
graph TD
    %% Styling - Ditambahkan color:#333333 agar teks terbaca di Dark Mode
    classDef layerBox fill:#f8f9fa,color:#333333,stroke:#dee2e6,stroke-width:2px,rx:10,ry:10;
    classDef clientBox fill:#f3f0ff,color:#333333,stroke:#d0bfff,stroke-width:2px,rx:8,ry:8;
    classDef gatewayBox fill:#e6fcf5,color:#333333,stroke:#96f2d7,stroke-width:2px,rx:8,ry:8;
    classDef coreBox fill:#e7f5ff,color:#333333,stroke:#a5d8ff,stroke-width:2px,rx:8,ry:8;
    classDef aiBox fill:#fff4e6,color:#333333,stroke:#ffd8a8,stroke-width:2px,rx:8,ry:8;
    classDef infraBox fill:#fff0f6,color:#333333,stroke:#ffdeeb,stroke-width:2px,rx:8,ry:8;
    classDef extBox fill:#f4fce3,color:#333333,stroke:#d8f5a2,stroke-width:2px,rx:8,ry:8;
    classDef nodeItem fill:#ffffff,color:#333333,stroke:#ced4da,stroke-width:1px,rx:5,ry:5;
